            ...
            if(eh_folha(**raiz))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            pai_aux = arvore23_buscar_pai(*origem, pai->info1.numero);
                        ...
                        {
                            pai_aux = arvore23_buscar_maior_pai(*origem, (*raiz)->info1.numero);
            ...
            if(eh_folha(**raiz))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            pai_aux = arvore23_buscar_menor_pai(*origem, (*raiz)->info1.numero);
